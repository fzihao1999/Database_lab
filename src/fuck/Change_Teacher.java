...
public class Change_Teacher {
  ...
  private void initialize() {
    ...
    textField.setBounds(215, 40, 108, 32);
    ...
    label.setBounds(89, 90, 115, 32);
    frame.getContentPane().add(label);
    
    textField_1 = new JTextField();
    textField_1.setColumns(10);
    textField_1.setBounds(215, 90, 108, 32);
    frame.getContentPane().add(textField_1);
    
    JLabel label_1 = new JLabel("开课学期：\r\n");
    label_1.setFont(new Font("微软雅黑", Font.PLAIN, 18));
    label_1.setBounds(90, 140, 115, 32);
    frame.getContentPane().add(label_1);
    
    textField_2 = new JTextField();
    textField_2.setColumns(10);
    textField_2.setBounds(215, 140, 108, 32);
    ...
    textField_4.setBounds(215, 190, 108, 32);
